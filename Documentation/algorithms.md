...
- <a href="#minMaxWithPivot">min_value_greater_than / max_value_less_than / max_value_less_than_unordered</a> (C++17)
...
<a name="minMaxWithPivot">min_value_greater_than | max_value_less_than | max_value_less_than_unordered</a> (C++17)
------------------------------------------------------------------------------------------------
