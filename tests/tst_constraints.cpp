...
FAIL_2_ARG(max_element_wrong_predicate, max_value, vector<int>, function<bool(string, string)>)
FAIL_2_ARG(max_element_no_return_value, max_value, vector<int>, function<void(int, int)>)
FAIL_2_ARG(max_element_only_one_arg, max_value, vector<int>, function<bool(int)>)
